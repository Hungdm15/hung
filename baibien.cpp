...
void setupLight() {
    ...
    GLfloat light0_pos[] = { 0.0f, 20.0f, 20.0f, 1.0f }; // dh
    GLfloat light0_ambient[] = { 0.6f, 0.4f, 0.2f, 1.0f };// môi trường 
    GLfloat light0_diffuse[] = { 1.0f, 1.0f, 1.0f, 1.0f };// khuếch tán
    GLfloat light0_specular[] = { 0.5f,0.5f, 0.8f, 0.5f }; // phản chiếu
...
void drawSnackBag() {
    ...
    for (int i = 0; i < 2; i++) { // 2 hình trụ
        ...
        gluDisk(quad, 0.0f, 0.1f, 20, 1);// vẽ đáy
        glPopMatrix();
        glPopMatrix();
    }
    //
...
void display() {
    ...
    //bánh snack
    glPushMatrix();     glTranslatef(-6.8f, 4.4, -1.3f); glScalef(0.5f, 0.5f, 0.5f);   glRotated(30, 0, 1, 0);glRotated(90, 1, 0, 0);    drawSnackBag();   glPopMatrix();
    //cỏ
...
void keyboard(unsigned char key, int x, int y) {
    ...
    case '3': case 'dh': toggledhlight1(); break; //bật/tắt ánh sáng định hướng của mặt trời
